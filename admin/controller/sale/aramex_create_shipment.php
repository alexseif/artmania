	...
	if(isset($this->request->post['weight_unit'])) {
		...
		if ($this->request->post) { 
			...
			try {
				...
				//$totalWeight = $this->request->post['order_weight'];
				$params = array();
				...
				if($this->request->post['aramex_shipment_info_billing_account'] == 3){
					$params['ThirdParty'] = array(
						...
						//Party Address
						'PartyAddress'		=> array(
									'Line1'					=> ($this->config->get('aramex_shipper_address'))?$this->config->get('aramex_shipper_address'):'', //'13 Mecca St',
									'Line2'					=> '',
									'Line3'					=> '',
									'City'					=> ($this->config->get('aramex_shipper_city'))?$this->config->get('aramex_shipper_city'):'', //'Dubai',
									'StateOrProvinceCode'	=> ($this->config->get('aramex_shipper_state'))?$this->config->get('aramex_shipper_state'):'', //'',
									'PostCode'				=> ($this->config->get('aramex_shipper_postal_code'))?$this->config->get('aramex_shipper_postal_code'):'',
									'CountryCode'			=> ($this->config->get('aramex_shipper_country_code'))?$this->config->get('aramex_shipper_country_code'):'', //'AE'
						),

						//Contact Info
						'Contact' 			=> array(
									'Department'			=> '',
									'PersonName'			=> ($this->config->get('aramex_shipper_name'))?$this->config->get('aramex_shipper_name'):'', //'Suheir',
									'Title'					=> '',
									'CompanyName'			=> ($this->config->get('aramex_shipper_company'))?$this->config->get('aramex_shipper_company'):'', //'Aramex',
									'PhoneNumber1'			=> ($this->config->get('aramex_shipper_phone'))?$this->config->get('aramex_shipper_phone'):'', //'55555555',
									'PhoneNumber1Ext'		=> '',
									'PhoneNumber2'			=> '',
									'PhoneNumber2Ext'		=> '',
									'FaxNumber'				=> '',
									'CellPhone'				=> ($this->config->get('aramex_shipper_phone'))?$this->config->get('aramex_shipper_phone'):'',
									'EmailAddress'			=> ($this->config->get('aramex_shipper_email'))?$this->config->get('aramex_shipper_email'):'', //'',
									'Type'					=> ''
						),
					);
				...
				try {
					...
					if($auth_call->HasErrors){
						...
						$this->response->redirect($this->url->link('sale/aramex_create_shipment', 'token=' . $this->session->data['token'] . '&order_id=' . $order_id , 'SSL'));
					}
				} catch (Exception $e) {
					$aramex_errors = true;
		...
		if (isset($this->session->data['success_html'])) {
			...
			$this->response->setOutput($this->load->view('sale/aramex_create_shipment.tpl', $data));
