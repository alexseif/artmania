...
class ControllerSaleAramexRateCalculator extends Controller {
	...
	$data['origin_country'] = ($this->config->get('aramex_shipper_country_code'))?$this->config->get('aramex_shipper_country_code'):'';
	$data['origin_city'] = ($this->config->get('aramex_shipper_city'))?$this->config->get('aramex_shipper_city'):'';
	$data['origin_zipcode'] = ($this->config->get('aramex_shipper_postal_code'))?$this->config->get('aramex_shipper_postal_code'):'';
	$data['origin_state'] = ($this->config->get('aramex_shipper_state'))?$this->config->get('aramex_shipper_state'):'';
	...
	*/
	...
	if($results->HasErrors){
		...
		$this->response->redirect($this->url->link('sale/aramex_rate_calculator', 'token=' . $this->session->data['token'] . '&order_id=' . $order_id , 'SSL'));
		...
		if (isset($this->session->data['rate_html'])) {
			...
			$this->response->setOutput($this->load->view('sale/aramex_rate_calculator.tpl', $data));
