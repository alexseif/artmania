...
class ControllerSaleAramexBulkSchedulePickup extends Controller {
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('sale/aramex_bulk_schedule_pickup', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$data['create'] = $this->url->link('sale/aramex_bulk_schedule_pickup/create', 'token=' . $this->session->data['token'], 'SSL');
		...
		$order_total = $this->model_sale_aramex->getTotalOrders($filter_data);
		...
		$data['sort_order'] = $this->url->link('sale/aramex_bulk_schedule_pickup', 'token=' . $this->session->data['token'] . '&sort=o.order_id' . $url, 'SSL');
		$data['sort_customer'] = $this->url->link('sale/aramex_bulk_schedule_pickup', 'token=' . $this->session->data['token'] . '&sort=customer' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('sale/aramex_bulk_schedule_pickup', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
		$data['sort_total'] = $this->url->link('sale/aramex_bulk_schedule_pickup', 'token=' . $this->session->data['token'] . '&sort=o.total' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('sale/aramex_bulk_schedule_pickup', 'token=' . $this->session->data['token'] . '&sort=o.date_added' . $url, 'SSL');
		$data['sort_date_modified'] = $this->url->link('sale/aramex_bulk_schedule_pickup', 'token=' . $this->session->data['token'] . '&sort=o.date_modified' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('sale/aramex_bulk_schedule_pickup', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('sale/aramex_bulk_schedule_pickup.tpl', $data));
	}
	...
	public function create() {
		...
		############ button ########## 
		   ...
		   $data['back_to_order'] = $this->url->link('sale/aramex_bulk_schedule_pickup', 'token=' . $this->session->data['token'] , 'SSL');
		############### label #############
					...
					$data['breadcrumbs'][] = array(
						...
						'href'      => $this->url->link('sale/aramex_bulk_schedule_pickup', 'token=' . $this->session->data['token'], 'SSL'),
						'separator' => ' :: '
					);
...
$no_shipments = (isset($this->request->post['no_shipments']))?$this->request->post['no_shipments']:'';		
		...
		if($results->HasErrors){
				...
				if (isset($this->session->data['success_html'])) {
					...
					$this->response->setOutput($this->load->view('sale/aramex_create_bulk_schedule_pickup.tpl', $data));
